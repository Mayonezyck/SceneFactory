...
from .scenefactory_marl_env_cfg import ScenefactoryMarlEnvCfg


class ScenefactoryMarlEnv(DirectMARLEnv):
    cfg: ScenefactoryMarlEnvCfg

    def __init__(self, cfg: ScenefactoryMarlEnvCfg, render_mode: str | None = None, **kwargs):
